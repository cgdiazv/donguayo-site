...
export default function Home() {
  return (
    <main className="min-h-screen bg-brand-white flex flex-col overflow-x-hidden">
      ...
      <section className="max-w-7xl mx-auto w-full px-6 md:px-12 pt-8 lg:pt-16 pb-24 grid grid-cols-1 lg:grid-cols-12 gap-12 items-center relative">
        
        {/* Columna Izquierda: Mensaje Monumental */}
        <div className="lg:col-span-7 flex flex-col items-start relative z-0">
